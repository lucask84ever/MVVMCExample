...
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified moviesTableView;
- (void)viewDidLoad;
...
@interface ViewController (SWIFT_EXTENSION(MVVMCExample)) <UITableViewDataSource>
